...
public class GameBlock extends Canvas {
  ...
  public GameBlock(GameBoard gameBoard, int x, int y, double width, double height) {
    ...
    if (gameBoard.getClass() == GameBoard.class) {
      setOnMouseEntered(
          (entered) -> {
            paintHover();
          });
  ...
  /** Paint this canvas with the image */
  private void paintColor() {
    ...
    // Colour fill
    var square = new Image(this.getClass().getResource("/images/square.png").toExternalForm());
    gc.setFill(Color.color(0, 0, 0, 0));
    gc.drawImage(square, x, y, getWidth() - 5, getHeight() - 5);
    gc.fillRect(0, 0, width, height);
  ...
  public void paintHover() {
    var gc = getGraphicsContext2D();
    var paw =
        new Image(this.getClass().getResource("/images/paw.png").toExternalForm());
    gc.setFill(Color.color(0, 0, 0, 0));
    gc.drawImage(paw, x+12, y+12, getWidth() - 30, getHeight()-30);
        ...
        new AnimationTimer() {
          ...
          public void handlee() {
            ...
            if (op <= 0) {
              ...
              gc.clearRect(0, 0, width, height);
              gc.fillRect(0, 0, width, height);
              gc.setFill(Color.color(1, 1, 1, op));
              gc.fillRect(0, 0, width, height);
